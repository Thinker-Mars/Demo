import cv2
import time
from .util import generate_result, check_source_larger_than_search, img_mat_rgb_2_gray
...
def print_run_time(func):
    ...
    def wrapper(self, *args, **kwargs):
        ...
        logger.info("%s() run time is %.2f s." % (func.__name__, time.time() - start_time))
        return ret
...
class TemplateMatching(object):
    ...
    def find_best_result(self):
        ...
        logger.info("[%s] threshold=%s, result=%s" % (self.METHOD_NAME, self.threshold, best_match))
